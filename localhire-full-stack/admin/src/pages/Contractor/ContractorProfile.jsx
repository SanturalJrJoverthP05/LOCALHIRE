...
const ContractorProfile = () => {
    ...
    const { dToken, profileData, setProfileData, getProfileData } = useContext(ContractorContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/contractor/update-profile', updateData, { headers: { dToken } })
